...
data object ViewRandomPost : NavigationAction()
...
data class SetAdvancedSearchParameters(val matchAll: Boolean, val exactMatch: Boolean) : SearchAction()
data class SetResultSize(val resultSize: Int) : SearchAction()
data object ViewRandomSearch : SearchAction()
